% sjasmplus(SECTION) | User Commands
%
% "March 17 2025"
...
sjasmplus - program to do something

# SYNOPSIS

**sjasmplus** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**sjasmplus** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **sjasmplus** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**sjasmplus** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    sjasmplus. See **foo.conf**(5) for further details.
...
**sjasmplus** provides some return codes, that can be used in scripts:
...
Guillermo Gutierrez <xiterrex@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Guillermo Gutierrez
